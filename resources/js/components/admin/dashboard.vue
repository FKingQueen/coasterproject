            ...
            <ul class="flex flex-col py-4 space-y-1">
              ...
              <li>
                <router-link to="/admin/slideShowPlatform" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-800 text-white hover:text-slate-300 border-l-4 border-transparent hover:border-blue-500 pr-6">
                  ...
                  <span class="ml-2 text-sm tracking-wide truncate">SlideShow Management</span>
                </router-link>
              ...
              <li>
                  <router-link to="/admin/setting" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-800 text-white hover:text-slate-300 border-l-4 border-transparent hover:border-blue-500 pr-6">
                      <span class="inline-flex justify-center items-center ml-4">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                      </span>
