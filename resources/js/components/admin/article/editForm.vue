        ...
        <div class="m-5 bg-white shadow-inner shadow-lg rounded px-20 py-5">
            ...
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="95" class="px-10">
                ...
                <FormItem label="Project">
                    <a-select v-model:value="formValidate.projectValue" mode="multiple" style="width: 100%"
                        placeholder="Please select" :options="projectOptions"></a-select>
                </FormItem>
                <FormItem label="Article Type" prop="typeValue">
                    <a-select :change="onChangeArticleType()" v-model:value="formValidate.typeValue" style="width: 100%"
                        placeholder="Please select" :options="typeOptions"></a-select>
                </FormItem>
                ...
                <FormItem label="Image" prop="image">
                    <Upload type="drag" ref="uploads"
                        ...
                        :on-success="handleSuccess" :on-error="handleError" :format="['jpg', 'jpeg', 'png']" :max-size="2048"
                        :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize" action="/api/admin/upload">
